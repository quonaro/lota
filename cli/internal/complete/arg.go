...
// nextArg returns the first argument in the line and the rest of the line.
func nextArg(line string) (arg Arg, after string) {
	defer arg.parse()
...
func (a *Arg) parse() {
	...
	// Separate the dashes from the flag name.
	dahsI := 1
